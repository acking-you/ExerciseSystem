...
QT_BEGIN_NAMESPACE_XLSX
    ...
    public:
        ...
        AbstractSheet *
        addSheet(const QString &name = QString(), AbstractSheet::SheetType type = AbstractSheet::ST_WorkSheet);
...
//    void addChart();
    ...
    private:
        ...
        AbstractSheet *
        addSheet(const QString &name, int sheetId, AbstractSheet::SheetType type = AbstractSheet::ST_WorkSheet);
    };
